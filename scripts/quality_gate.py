...
TESTS = [
    ...
    ("learning writeback pipeline", ["docs/tests/scripts/learning_pipeline_test.py"], False),
    ("release contract", ["docs/tests/scripts/release_contract_test.py"], False),
    ("Obsidian vault", ["docs/tests/scripts/agent_os_vault_test.py"], False),
    ("ontology vault export", ["docs/tests/scripts/ontology_vault_export_test.py"], False),
